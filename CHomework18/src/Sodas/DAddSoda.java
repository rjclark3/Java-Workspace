...
public class DAddSoda extends JDialog implements ActionListener
{
	// --------------------------------------------------------------------------------
	// Name: Controls
	// Abstract: This class ...
	...
	private int m_intNewSodaID = 0;
	private boolean m_blnResult = false;
	public DAddSoda( JDialog dlgParent)
	{
...
// -------------------------------------------------------------
	...
	public void AddControls()
	{
		try
		{
			...
			// First Name
			m_lblSoda = CUtilities.AddLabel( this, "Soda:*", 25, 20 );
	...
	private udtSodaType GetValuesFromForm( )
	{
		...
		try
		{
			...
			udtSoda.intSodaID 			= m_intNewSodaID;
			udtSoda.strSoda 			= m_txtSoda.getText( );

			// Soda
			if( m_txtSoda.getText().equals( "" ) == false )
			{
				udtSoda.strSoda = m_txtSoda.getText();
			}
	...
	private boolean SaveData()
	{
		...
		try
		{
			...
			blnResult = CDatabaseUtilities.AddSodaToDatabase( udtNewSoda );
			
			// Did it work?
			if( blnResult == true )
			{
				// Yes, save the new Soda ID
				m_intNewSodaID = udtNewSoda.intSodaID;
			}
		}
		catch(Exception excError)
		{
